...
TO LOAD TENSORBOARD, AFTER RUNNING THE SCRIPT, WRITE ON THE TERMINAL:
    $ tensorboard --logdir artifacts/tb_logs/
...
import matplotlib
matplotlib.use('Agg')
import matplotlib.pyplot as plttensorboard
import numpy as np
import torch
...
def main():
    ...
    # ——— Log final metrics e chiudi TensorBoard ———
    writer.add_scalars("Metrics/Final", {
